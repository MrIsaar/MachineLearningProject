import pandas as pd
import numpy as np
from fileHandling import genericfiles
...
def learnfromFile(trainingFile,save="user"):
  """Learns from a file of examples and saves neural network
     code credit to 
